# Candidate projects & state-of-field baseline

The science backlog for the theory wing. Four seed projects (A–D) with their June-2026
baselines; the leverage ranking that orders them lives in [`directions.md`](./directions.md)
(thesis) and [`field-map.md`](./field-map.md) (effort data), with the active build in
[`euclid-dr1-prep.md`](./euclid-dr1-prep.md).

## The four seed projects

### A. Wide-binary gravity test (MOND vs. Newton)
...
### C. Tension census (living literature database)
...
The dataset is the literature, distilled. Feeds future candidate hunts.
...
See [`directions.md`](./directions.md) for the **leverage map** (effort × tractability), the
higher-leverage additions — **E** galaxy-formation systematics audit, **F** reheating /
post-inflationary GW scorecard (the Copeland thread), **G** cosmic-dipole / isotropy audit
(the current lead, now the active build), **H** cosmic birefringence — and **C′**, the
field-cartography meta-project that steers which we invest in.
